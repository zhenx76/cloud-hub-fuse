(function ()
{
    ...
    function apiService($resource)
    {
        ...
        // Device Registry API
        api.deviceRegistry = {
            list: $resource(api.baseUrl + 'registry/devices'),
        ...
        api.RegisteredDevices = $resource(api.baseUrlFile + 'devices/registeredDevices.json');
        api.shop = $resource(api.baseUrlFile + 'shop/shop.json');
        api.design = $resource(api.baseUrlFile + 'design/design.json');

        api.quickPanel = {
            activities: $resource(api.baseUrlFile + 'quick-panel/activities.json'),
            contacts  : $resource(api.baseUrlFile + 'quick-panel/contacts.json'),
            events    : $resource(api.baseUrlFile + 'quick-panel/events.json'),
            notes     : $resource(api.baseUrlFile + 'quick-panel/notes.json')
        };
